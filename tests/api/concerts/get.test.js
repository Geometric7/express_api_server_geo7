...
describe('GET/api/concerts', function () {
  ...
  it('TEST_1 - / should return all concerts', async () => {
	...
	it('TEST_2 - /:id should return one concert by :id ', async () => {
	...
	it('TEST_3 - /performer/:performer should return an array with concerts filtered by performer', async () => {
	...
	it('TEST_4 - /genre/:genre should return an array with concerts filtered by genre', async () => {
	...
	it('TEST_5 - /price/:price_min/:price_max should return an array with concerts filtered by price', async () => {
	...
	it('TEST_6 - /day/:day should return an array with concerts filtered by day ', async () => {
